    ...
    verifyForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            if (data.isAuth) {
                ...
                localStorage.setItem("avatarUrl", "/frontend/images/profile.png"); // Giả sử abc.jpg là ảnh avatar
                localStorage.setItem("helloName", "Hello Nam Le,"); // Giả sử abc.jpg là ảnh avatar
                window.location.href = "/frontend/html/index.html"; // Điều hướng đến trang home
            } else {
                alert(data.message);
            }
        } catch (error) {
